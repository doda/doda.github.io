(function(){const a=33;let o=!1,i=!0,t=new Set;const d=`
  ...
  `,p=`
    ...
    void main() {
      ...
      vec2 p1 = p * 0.25 + vec2(u_time * 0.01, u_time * 0.008);
      float field1 = metaball(warpCoords(p1, u_time * 0.3), u_time * 0.3) + wallInfluence;

      // Layer 2 - medium
      vec2 p2 = p * 0.5 + vec2(u_time * 0.02, -u_time * 0.012);
      float field2 = metaball(warpCoords(p2 + 50.0, u_time * 0.5), u_time * 0.5) + wallInfluence;

      // Layer 3 - smallest, fastest (front)
      vec2 p3 = p * 0.8 + vec2(u_time * 0.035, u_time * 0.018);
      float field3 = metaball(warpCoords(p3 + 100.0, u_time * 0.7), u_time * 0.7) + wallInfluence;
