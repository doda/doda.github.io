(function(){const v=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(v)return;const c=66,h=100;let a=!1,o=!0,s=!0,n=new Set;const b=`
  ...
  `,u=`
    ...
    void main() {
      ...
      // Start with the lightest layer color as base (no white showing through)
      vec3 color = layer1;
      ...
      for (int i = 0; i < 5; i++) {
        ...
        // Threshold: tight (0.95) to loose (0.25) - front layers fill more
        float threshold = 0.95 - t * 0.70;
        // Offset for variety
