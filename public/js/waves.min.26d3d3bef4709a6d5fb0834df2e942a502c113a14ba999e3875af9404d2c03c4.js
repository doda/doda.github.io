(function(){const a=33;let o=!1,i=!0,t=new Set;const d=`
  ...
  `,p=`
    ...
    void main() {
      ...
      // Cool palette - blues and teals
      vec3 lightPageBg = vec3(1.0, 1.0, 1.0);
      vec3 lightLayer1 = vec3(0.88, 0.91, 0.94);  // Pale ice blue
      vec3 lightLayer2 = vec3(0.80, 0.85, 0.90);  // Soft sky
      vec3 lightLayer3 = vec3(0.70, 0.78, 0.86);  // Steel blue

      vec3 darkPageBg = vec3(0.10, 0.12, 0.15);
      vec3 darkLayer1 = vec3(0.15, 0.18, 0.24);   // Deep navy
      vec3 darkLayer2 = vec3(0.18, 0.24, 0.32);   // Ocean blue
      vec3 darkLayer3 = vec3(0.22, 0.32, 0.42);   // Teal blue
