(function(){const v=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(v)return;const c=42,h=100;let a=!1,o=!0,s=!0,n=new Set;const b=`
  ...
  `,u=`
    ...
    void main() {
      ...
      // Monochrome palette - white integrates as lightest layer
      vec3 lightPageBg = vec3(1.0, 1.0, 1.0);
      vec3 lightLayer1 = vec3(0.98, 0.98, 0.98);  // Near-white (back)
      vec3 lightLayer2 = vec3(0.95, 0.95, 0.95);  // Mid
      vec3 lightLayer3 = vec3(0.91, 0.91, 0.91);  // Darkest (front)

      // PaperMod dark: rgb(29, 30, 32) = 0.114, 0.118, 0.125
      vec3 darkPageBg = vec3(0.114, 0.118, 0.125);
      vec3 darkLayer1 = vec3(0.14, 0.14, 0.15);   // Lightest
      vec3 darkLayer2 = vec3(0.17, 0.17, 0.18);   // Mid
      vec3 darkLayer3 = vec3(0.20, 0.20, 0.21);   // Darkest
