(function(){const v=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(v)return;const c=66,h=100;let a=!1,o=!0,s=!0,n=new Set;const b=`
  ...
  `,u=`
    ...
    void main() {
      ...
      // Solid background layer below boundary - ensures no white pokes through
      float bgFade = smoothstep(boundary + 20.0 * u_dpr, boundary - 10.0 * u_dpr, pixelY);
      color = mix(color, layer1, bgFade);
