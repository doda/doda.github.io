(function(){const f=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(f)return;const c=42,m=100;let a=!1,i=!0,s=!0,n=new Set;const b=`
  ...
  `;function l(e,t,n){const s=e.createShader(t);return e.shaderSource(s,n),e.compileShader(s),s}function p(){return document.documentElement.getAttribute("data-theme")==="dark"?1:0}function j(){const t=getComputedStyle(document.body),n=t.backgroundColor,e=n.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return e?[parseInt(e[1])/255,parseInt(e[2])/255,parseInt(e[3])/255]:[1,1,1]}function h(e,t){const o=document.getElementById(e);if(!o)return null;const n=o.getContext("webgl2",{antialias:!0,powerPreference:"low-power"})||o.getContext("webgl",{antialias:!0,powerPreference:"low-power"});if(!n)return null;const a=l(n,n.VERTEX_SHADER,b),r=l(n,n.FRAGMENT_SHADER,v),s=n.createProgram();n.attachShader(s,a),n.attachShader(s,r),n.linkProgram(s),n.useProgram(s);const c=n.createBuffer();n.bindBuffer(n.ARRAY_BUFFER,c),n.bufferData(n.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),n.STATIC_DRAW);const i=n.getAttribLocation(s,"a_position");return n.enableVertexAttribArray(i),n.vertexAttribPointer(i,2,n.FLOAT,!1,0,0),{canvas:o,gl:n,resolutionLoc:n.getUniformLocation(s,"u_resolution"),timeLoc:n.getUniformLocation(s,"u_time"),isDarkLoc:n.getUniformLocation(s,"u_isDark"),fadeTopLoc:n.getUniformLocation(s,"u_fadeTop"),dprLoc:n.getUniformLocation(s,"u_dpr"),hoverLoc:n.getUniformLocation(s,"u_hover"),bgColorLoc:n.getUniformLocation(s,"u_bgColor"),hoverTarget:0,hoverValue:0,needsResize:!0,fadeTop:t?1:0}}let e=[],u=performance.now(),o=0,d=window.devicePixelRatio;function g(){const e=window.devicePixelRatio;return e<=1?1.5:e}function t(a){if(!i||n.size===0){requestAnimationFrame(t);return}const f=s?c:m;if(a-o<f){requestAnimationFrame(t);return}o=a;const v=(performance.now()-u)/1e3,b=p(),l=window.devicePixelRatio;l!==d&&(d=l,e.forEach(e=>e.needsResize=!0));const r=g(),h=c/1e3;for(const t of e){if(!n.has(t.canvas))continue;const{canvas:o,gl:s,resolutionLoc:a,timeLoc:c,isDarkLoc:l,fadeTopLoc:d,dprLoc:u,hoverLoc:m}=t;t.needsResize&&(o.width=o.offsetWidth*r,o.height=o.offsetHeight*r,s.viewport(0,0,o.width,o.height),s.uniform2f(a,o.width,o.height),s.uniform1f(d,t.fadeTop),t.needsResize=!1);const i=1/2.65;t.hoverTarget>t.hoverValue?t.hoverValue=Math.min(t.hoverTarget,t.hoverValue+h*i):t.hoverTarget<t.hoverValue&&(t.hoverValue=Math.max(t.hoverTarget,t.hoverValue-h*i)),s.uniform1f(c,v),s.uniform1f(l,b),s.uniform1f(u,r),s.uniform1f(m,t.hoverValue),s.drawArrays(s.TRIANGLE_STRIP,0,4)}requestAnimationFrame(t)}function r(){if(a)return;if(a=!0,e=[h("footer-canvas",!0)].filter(Boolean),e.length===0)return;e.forEach(e=>{const t=e.canvas.parentElement;t&&(t.addEventListener("mouseenter",()=>e.hoverTarget=1),t.addEventListener("mouseleave",()=>e.hoverTarget=0))}),document.addEventListener("visibilitychange",()=>{i=!document.hidden}),window.addEventListener("focus",()=>{s=!0}),window.addEventListener("blur",()=>{s=!1});const o=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?n.add(e.target):n.delete(e.target)})},{threshold:0});e.forEach(e=>o.observe(e.canvas)),window.addEventListener("resize",()=>e.forEach(e=>e.needsResize=!0)),t(performance.now())}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r()})()