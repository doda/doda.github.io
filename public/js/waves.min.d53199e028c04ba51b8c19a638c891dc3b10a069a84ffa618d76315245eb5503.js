(function(){const v=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(v)return;const c=66,h=100;let a=!1,o=!0,s=!0,n=new Set;const b=`
  ...
  `,u=`
    ...
    void main() {
      ...
      // Monochrome palette - lighter range
      vec3 lightPageBg = vec3(1.0, 1.0, 1.0);
      vec3 lightLayer1 = vec3(0.96, 0.96, 0.96);  // Lightest (back)
      vec3 lightLayer2 = vec3(0.94, 0.94, 0.94);  // Mid
      vec3 lightLayer3 = vec3(0.92, 0.92, 0.92);  // Darkest (front)
