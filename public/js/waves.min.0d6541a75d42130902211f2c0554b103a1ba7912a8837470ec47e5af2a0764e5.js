(function(){const a=33;let o=!1,i=!0,t=new Set;const d=`
  ...
  `,p=`
    ...
    void main() {
      ...
      vec3 lightLayer1 = vec3(0.94, 0.94, 0.94);  // Lightest
      vec3 lightLayer2 = vec3(0.87, 0.87, 0.87);  // Medium
      vec3 lightLayer3 = vec3(0.78, 0.78, 0.78);  // Darkest

      vec3 darkPageBg = vec3(0.12, 0.12, 0.12);
      vec3 darkLayer1 = vec3(0.18, 0.18, 0.18);   // Lightest
      vec3 darkLayer2 = vec3(0.24, 0.24, 0.24);   // Medium
      vec3 darkLayer3 = vec3(0.32, 0.32, 0.32);   // Darkest
