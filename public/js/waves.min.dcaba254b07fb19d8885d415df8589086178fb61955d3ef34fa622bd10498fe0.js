(function(){const a=33;let o=!1,i=!0,t=new Set;const d=`
  ...
  `,p=`
    ...
    void main() {
      ...
      // Pink palette - blush to rose
      vec3 lightPageBg = vec3(1.0, 1.0, 1.0);
      vec3 lightLayer1 = vec3(0.96, 0.90, 0.92);  // Pale blush
      vec3 lightLayer2 = vec3(0.92, 0.82, 0.86);  // Soft rose
      vec3 lightLayer3 = vec3(0.86, 0.72, 0.78);  // Dusty pink

      vec3 darkPageBg = vec3(0.14, 0.10, 0.12);
      vec3 darkLayer1 = vec3(0.24, 0.16, 0.20);   // Deep plum
      vec3 darkLayer2 = vec3(0.34, 0.20, 0.26);   // Berry
      vec3 darkLayer3 = vec3(0.44, 0.26, 0.34);   // Mauve
