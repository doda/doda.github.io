(function(){const h=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(h)return;const a=33;let o=!1,l=!0,t=new Set;const g=`
  ...
  `;function r(e,t,n){const s=e.createShader(t);return e.shaderSource(s,n),e.compileShader(s),s}function m(){return document.body.classList.contains("dark")?1:0}function d(e,t){const o=document.getElementById(e);if(!o)return null;const n=o.getContext("webgl2",{antialias:!0,powerPreference:"low-power"})||o.getContext("webgl",{antialias:!0,powerPreference:"low-power"});if(!n)return null;const a=r(n,n.VERTEX_SHADER,g),c=r(n,n.FRAGMENT_SHADER,p),s=n.createProgram();n.attachShader(s,a),n.attachShader(s,c),n.linkProgram(s),n.useProgram(s);const l=n.createBuffer();n.bindBuffer(n.ARRAY_BUFFER,l),n.bufferData(n.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),n.STATIC_DRAW);const i=n.getAttribLocation(s,"a_position");return n.enableVertexAttribArray(i),n.vertexAttribPointer(i,2,n.FLOAT,!1,0,0),{canvas:o,gl:n,resolutionLoc:n.getUniformLocation(s,"u_resolution"),timeLoc:n.getUniformLocation(s,"u_time"),isDarkLoc:n.getUniformLocation(s,"u_isDark"),fadeTopLoc:n.getUniformLocation(s,"u_fadeTop"),dprLoc:n.getUniformLocation(s,"u_dpr"),hoverLoc:n.getUniformLocation(s,"u_hover"),hoverTarget:0,hoverValue:0,needsResize:!0,fadeTop:t?1:0}}let e=[],u=performance.now(),s=0,c=window.devicePixelRatio;function f(){const e=window.devicePixelRatio;return e<=1?1.5:e}function n(o){if(!l||t.size===0){requestAnimationFrame(n);return}if(o-s<a){requestAnimationFrame(n);return}s=o;const h=(performance.now()-u)/1e3,p=m(),r=window.devicePixelRatio;r!==c&&(c=r,e.forEach(e=>e.needsResize=!0));const i=f(),d=a/1e3;for(const n of e){if(!t.has(n.canvas))continue;const{canvas:o,gl:s,resolutionLoc:r,timeLoc:c,isDarkLoc:l,fadeTopLoc:u,dprLoc:m,hoverLoc:f}=n;n.needsResize&&(o.width=o.offsetWidth*i,o.height=o.offsetHeight*i,s.viewport(0,0,o.width,o.height),s.uniform2f(r,o.width,o.height),s.uniform1f(u,n.fadeTop),n.needsResize=!1);const a=1/2.65;n.hoverTarget>n.hoverValue?n.hoverValue=Math.min(n.hoverTarget,n.hoverValue+d*a):n.hoverTarget<n.hoverValue&&(n.hoverValue=Math.max(n.hoverTarget,n.hoverValue-d*a)),s.uniform1f(c,h),s.uniform1f(l,p),s.uniform1f(m,i),s.uniform1f(f,n.hoverValue),s.drawArrays(s.TRIANGLE_STRIP,0,4)}requestAnimationFrame(n)}function i(){if(o)return;if(o=!0,e=[d("footer-canvas",!0)].filter(Boolean),e.length===0)return;e.forEach(e=>{const t=e.canvas.parentElement;t&&(t.addEventListener("mouseenter",()=>e.hoverTarget=1),t.addEventListener("mouseleave",()=>e.hoverTarget=0))}),document.addEventListener("visibilitychange",()=>{l=!document.hidden});const s=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?t.add(e.target):t.delete(e.target)})},{threshold:0});e.forEach(e=>s.observe(e.canvas)),window.addEventListener("resize",()=>e.forEach(e=>e.needsResize=!0)),n(performance.now())}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i):i()})()