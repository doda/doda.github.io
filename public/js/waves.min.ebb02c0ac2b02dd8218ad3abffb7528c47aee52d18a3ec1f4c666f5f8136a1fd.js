(function(){const a=33;let o=!1,i=!0,t=new Set;const d=`
  ...
  `,p=`
    ...
    void main() {
      ...
      vec2 p1 = p * 0.5 + vec2(u_time * 0.015, u_time * 0.01);
      float field1 = metaball(warpCoords(p1, u_time * 0.4), u_time * 0.4) + wallInfluence;

      // Layer 2 - medium
      vec2 p2 = p * 0.7 + vec2(u_time * 0.025, -u_time * 0.015);
      float field2 = metaball(warpCoords(p2 + 50.0, u_time * 0.6), u_time * 0.6) + wallInfluence;

      // Layer 3 - smallest, fastest (front)
      vec2 p3 = p * 1.0 + vec2(u_time * 0.04, u_time * 0.02);
      float field3 = metaball(warpCoords(p3 + 100.0, u_time * 0.8), u_time * 0.8) + wallInfluence;
